...
if st.session_state.pending_event:
    ...
    with st.chat_message("assistant"):
        ...
        if btn_add.button("✅ Add it", key="confirm"):
            add_event_to_calendar(ev)
        if btn_cancel.button("✗ Cancel", key="cancel"):
            st.session_state.pending_event = None
...
user_input = st.chat_input("e.g. 'Coffee with Sara next Tuesday 10am at Lot Sixty One'")
